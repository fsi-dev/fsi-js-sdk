...
var AfricasTalking = /** @class */ (function () {
    function AfricasTalking(testKey) {
        ...
        this.getTransaction = function (body, header) { return africasTalkingAirtime.transactionStatus(_this.secretKey, body, header); };
        /*Sms*/
        ...
        this.createSubscription = function (body, header) { return africasTalkingSms.createSubscription(_this.secretKey, body, header); };
        this.fetchSubscriptions = function (body, header) { return africasTalkingSms.fetchSubscriptions(_this.secretKey, body, header); };
        this.deleteSubscription = function (body, header) { return africasTalkingSms.deleteSubscription(_this.secretKey, body, header); };
